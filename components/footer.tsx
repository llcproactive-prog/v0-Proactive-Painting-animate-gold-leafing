  ...
  return (
    <footer className="bg-[#3a342c] text-[rgba(248,243,233,0.65)] py-12 text-sm">
      <div className="max-w-[1180px] mx-auto px-7 grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr] gap-10">
        <div>
          <div className="font-[var(--font-instrument)] text-[#f0c9a8] text-xl mb-3">Proactive Painting</div>
        ...
        <div>
          <div className="font-[var(--font-instrument)] text-[#f0c9a8] text-xl mb-3">Get in touch</div>
          <a
        ...
        <div>
          <div className="font-[var(--font-instrument)] text-[#f0c9a8] text-xl mb-3">The details</div>
          <p className="leading-relaxed">
            CSLB C-33 Licensed
            <br />
            Fully Insured
